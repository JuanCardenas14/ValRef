...
MOM<- read_excel("E://Informaciòn/Pictures/Downloads/MOM1_Octubre_1.xlsx")

ECG_rep_EM <- read_excel("E:/Informaciòn/Pictures/Downloads/CPET_max.xlsx", 
                         skip = 1)

Info_base <- ECG_rep_EM %>% rename (Individuo = participant_id)

View(Info_base)

MOM1 <- inner_join(Info_base, MOM)
...
Ecuaciones_hombres <- Hombres %>%
  ...
  mutate(Jones_1_85 = ((-3.76 + (-0.028 * edad_ca_em) + 
         ...
         Mylius_3_19 = (-2537.29 + (743.35*1) +
                          ...
                          (24.3*estatur_ea)+
                          (12.57*pes_tot_ea)),
         Tammelin_1_04_kg = (90 + (-0.16*HRmax)),
         Tammelin_2_04_kg = (77.69 + (-0.23*HRmax) +
                            (-0.9*imc_cal_ea)),
         ...
         Kokkinos_1_18_kg = (3.5 + (1.76*(Wmax*6.12/pes_tot_ea))),
         Kokkinos_3_18_kg = (3.5 + (1.74*(Wmax*6.12/pes_tot_ea))))

  VO2_abs_hombres <- Ecuaciones_hombres %>%
  select(VO2max, Jones_1_85, Jones_3_85, Jones_4_85, 
...
Ecuaciones_mujeres <- Mujeres %>%
  ...
  mutate(Jones_2_85 = ((-2.26 + (-0.018 * edad_ca_em) + 
         ...
         Mylius_4_19 = (-2537.29 + (743.35*0) +
                          ...
                          (24.3*estatur_ea)+
                          (12.57*pes_tot_ea)),
         Tammelin_1_04_kg = (70.06 + (-0.16*HRmax)),
         Tammelin_2_04_kg = (65.67 + (-0.21*HRmax) +
                               (-0.53*imc_cal_ea)),
         Koch_1_09_kg = (47.7565 + (-0.988*1) +
                           (-8.8697*2) +
                           (2.3597*1)+
         ...
         Itoh_1_13_kg = (42.05 + (-0.268*edad_ca_em)+
                           (-7.22*1)),
         Kokkinos_1_18_kg = (3.5 + (1.65*(Wmax*6.12/pes_tot_ea))),
         Kokkinos_3_18_kg = (3.5 + (1.74*(Wmax*6.12/pes_tot_ea))))

a <- Ecuaciones_mujeres %>%
  select(VO2max, Jones_2_85, Jones_3_85, Jones_4_85, 
